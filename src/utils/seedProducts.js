...
// Dados dos produtos para cadastro automático
...
const productsData = [
  {
    ...
    description: "Óleo de coco extravirgem 100% natural, prensado a frio. Ideal para culinária, hidratação da pele e cabelos.",
    category: "Óleos",
    stock: 50,
  ...
  },
  {
    ...
    description: "Mel silvestre puro e natural, colhido de forma sustentável. Rico em nutrientes e antioxidantes.",
    category: "Alimentos",
    stock: 35,
  ...
  },
  {
    ...
    description: "Chá verde orgânico de alta qualidade. Auxilia no metabolismo e é rico em antioxidantes.",
    category: "Bebidas",
    stock: 60,
  ...
  },
  {
    ...
    description: "Granola artesanal com mix de castanhas, aveia e frutas secas. Sem adição de açúcar refinado.",
    category: "Alimentos",
    stock: 45,
  ...
  },
  {
    ...
    description: "Spirulina em pó 100% pura. Superalimento rico em proteínas, vitaminas e minerais.",
  ...
  },
  {
    ...
    description: "Polpa de açaí puro congelado, sem adição de xaropes ou conservantes. Direto da Amazônia.",
    category: "Alimentos",
    stock: 25,
  ...
  },
  {
    ...
    description: "Castanhas do Pará selecionadas, ricas em selênio. Excelente fonte de energia e nutrientes.",
    category: "Alimentos",
    stock: 40,
  ...
  },
  {
    ...
    description: "Óleo essencial de lavanda 100% puro. Propriedades calmantes e relaxantes para aromaterapia.",
    category: "Óleos",
    stock: 55,
  ...
  },
  {
    ...
    description: "Proteína vegetal de alta qualidade, blend de ervilha e arroz. Ideal para atletas.",
    category: "Suplementos",
    stock: 20,
  ...
  },
  {
    ...
    description: "Extrato de própolis verde brasileiro. Fortalece a imunidade e possui propriedades antibacterianas.",
    category: "Suplementos",
    stock: 65,
  ...
  },
  {
    ...
    description: "Colágeno hidrolisado em pó, fácil absorção. Auxilia na saúde da pele, cabelos e unhas.",
    category: "Suplementos",
    stock: 42,
  ...
  },
  {
    ...
    description: "Sementes de chia ricas em ômega-3 e fibras. Excelente para sucos, iogurtes e receitas.",
    category: "Alimentos",
    stock: 70,
  ...
  },
  {
    ...
    description: "Azeite de oliva extra virgem importado. Prensado a frio, sabor suave e frutado.",
    category: "Óleos",
    stock: 33,
  ...
  },
  {
    ...
    description: "Pasta de amendoim 100% integral, sem adição de açúcar ou sal. Rica em proteínas.",
    category: "Alimentos",
    stock: 48,
  ...
  },
  {
    ...
    description: "Farinha de amêndoas pura, ideal para receitas low carb e sem glúten.",
    category: "Alimentos",
    stock: 28,
  ...
  },
  {
    ...
    description: "Cúrcuma em pó 100% natural. Poderoso anti-inflamatório e antioxidante.",
    category: "Alimentos",
    stock: 90,
  ...
  },
  {
    ...
    description: "Óleo de linhaça prensado a frio, rico em ômega-3. Excelente para saladas.",
    category: "Óleos",
    stock: 36,
...
export const seedProducts = () => {
  ...
  console.log(`✅ ${productsWithId.length} produtos cadastrados!`);
  return true;
};
